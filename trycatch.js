...
let archivo = "/prologo.txt";
function lecturaArchivo(archivo, procesarContenido, mejorarError) {
    try {
        procesarContenido(archivo);
    } catch {
        mejorarError(error);
    }
}
lecturaArchivo(archivo, () => {console.log(archivo)}, () => {throw new Error("Ocurrió un error")});
